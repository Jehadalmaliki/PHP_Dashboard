...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($con, "insert into product(product_id,product_name,product_price,product_image,category_id) value(null,'$productname', '$productprice','$img','$categoryname' )");
    if ($query) {
